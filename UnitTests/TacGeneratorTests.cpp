...
BOOST_AUTO_TEST_CASE( Divide_InvalidOperands )
{
    ...
    BOOST_CHECK_THROW( m_generator->Divide( invalidOperand, validOperand, instructions ), std::invalid_argument );
    BOOST_CHECK_THROW( m_generator->Divide( validOperand, invalidOperand, instructions ), std::invalid_argument );
    BOOST_CHECK_THROW( m_generator->Divide( invalidOperand, invalidOperand2, instructions ), std::invalid_argument );
}
...
BOOST_AUTO_TEST_CASE( DivideByZero )
{
    ...
    BOOST_CHECK_THROW( m_generator->Divide( validOperand, zeroOperand, instructions ), std::invalid_argument );
}
...
BOOST_AUTO_TEST_CASE( Divide_Success_TwoLiterals )
{
    ...
    BOOST_CHECK_EQUAL( 0u, instructions.size() );
    Operand result = m_generator->Divide( operand1, operand2, instructions );
